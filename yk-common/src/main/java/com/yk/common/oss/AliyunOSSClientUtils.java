...
public class AliyunOSSClientUtils {
	...
	// accessKey
	private String accessKeyId = "LTAI4FhHYPsELSRreNVi2Zyr";
	private String accessKeySecret = "F8Ix7D1uimpQhAoXOvXba487iAnV98";
	// 空间
	private String bucketName = "aisileimg04";
	// 文件存储目录
